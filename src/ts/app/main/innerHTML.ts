...
const mainContent0 = `
  ...
  <p>This page is my own attemption to implement the MCV pattern. Maybe, not quite successful, and even awful... )</p>
  <p>But, as I have already said, I am beginner. I am not a wizard, I have been studying yet...</p>
`;
